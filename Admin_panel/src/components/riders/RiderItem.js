...
import "react-toastify/dist/ReactToastify.css";
 const RiderItem = ({data,index,currentPage, blockToggle,selection}) => {
    return (
    <Fragment>
      {data === null ? (
        <Spinner />
        ...
        <tr role="row" className="odd">
                              ...
                              <td className="py-0">{data.firstname+" "+ data.lastname}</td>
                              <td className="py-0">{data.status?<i className="fas fa-circle" style={{color: 'green', fontSize: '14px'}} ></i>:<i className="fas fa-circle" style={{color: 'red', fontSize: '14px'}}></i>}</td>
                              <td className="py-0">{data.email}</td>
                              <td className="py-0">+1-541-754-3010</td>
                              <td className="py-0">{data.availability}</td>
                              <td className="py-0">
...
export default connect(null, {})(RiderItem);
