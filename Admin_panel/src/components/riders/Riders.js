...
import { getRiders, UpdateUserStatus,SortAction } from '../../actions/profile';
...
const Riders = ({ getRiders,SortAction, UpdateUserStatus, profile: { Riders, loading }, history }) => {
  ...
  useEffect(() => {
// alert(Selection)
    getRiders(page,limit,Selection);
  }, [getRiders,page,limit,Selection]);
    ...
    <Fragment>
      {loading ? (
        ...
        <div className="content-wrapper">
          ...
          <h3 className="pull-left bold uppercase black mt-2">Riders</h3>
          <div className="clearfix" />
          <h3 className="pull-left p_lg medium black mt-2">Riders Log</h3>
          <div className="d-flex mt-3 align-items-center justify-content-between flex-wrap">
            ...
            <div>
              <a href="blocked-users.html"><button className="px-3 py-0 h-45">Block Riders</button></a>
            ...
            <div className="card-content collapse show">
              <div className="card-body table-responsive card-dashboard">
                ...
                <div className>
                  ...
                  <thead>
          <tr role="row"><th className="d-grey bold sorting_asc" tabIndex={0} aria-controls="DataTables_Table_0" rowSpan={1} colSpan={1} aria-sort="ascending" aria-label="S.NO: activate to sort column descending" style={{width: '89.8125px'}}>S.NO</th><th className="d-grey bold sorting" tabIndex={0} aria-controls="DataTables_Table_0" rowSpan={1} colSpan={1} aria-label="Rider name: activate to sort column ascending" style={{width: '207.812px'}}>Rider name</th><th className="d-grey bold sorting" tabIndex={0} aria-controls="DataTables_Table_0" rowSpan={1} colSpan={1} aria-label="status: activate to sort column ascending" style={{width: '130.812px'}}>status</th><th className="d-grey bold sorting" tabIndex={0} aria-controls="DataTables_Table_0" rowSpan={1} colSpan={1} aria-label="Email: activate to sort column ascending" style={{width: '383.812px'}}>Email</th><th className="d-grey bold sorting" tabIndex={0} aria-controls="DataTables_Table_0" rowSpan={1} colSpan={1} aria-label="Phone no: activate to sort column ascending" style={{width: '271.812px'}}>Phone no</th><th className="d-grey bold sorting" tabIndex={0} aria-controls="DataTables_Table_0" rowSpan={1} colSpan={1} aria-label="Availability: activate to sort column ascending" style={{width: '216.812px'}}>Availability</th><th className="d-grey text-center bold sorting" tabIndex={0} aria-controls="DataTables_Table_0" rowSpan={1} colSpan={1} aria-label="Action: activate to sort column ascending" style={{width: '134.812px'}}>Action</th></tr>
        </thead>
           ...
           Object.keys(Riders).length > 0 ? (
            Riders.data.map((user,index) => (
           <RiderItem key={user._id} blockToggle={blockToggleUser} data={user} currentPage={Riders.currentPage} index={index} selection={Selection}/>
         ))
       ) : (
         <h4>No User found...</h4>
       )
...
export default connect(mapStateToProps, { getRiders, UpdateUserStatus,SortAction })(Riders);
