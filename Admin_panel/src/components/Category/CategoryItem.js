...
import { ToastContainer } from "react-toastify";
 const CategoryItem = ({data,index,currentPage, blockToggle,selection}) => {
    return (
    <Fragment>
      {data === null ? (
        <Spinner />
        ...
        <tr role="row" className="odd">
                              ...
                              <td className="py-0">{data.name}</td>
        
                              <td className="py-0"><img src="images/green-dot.png" alt="" className="img-fluid" /></td>
                              ...
                              <td className="py-0">
                                <div className="btn-group mr-1 mb-1">
                                  ...
                                  <div className="dropdown-menu" x-placement="bottom-start" style={{position: 'absolute', transform: 'translate3d(0px, 21px, 0px)', top: '0px', left: '0px', willChange: 'transform'}}>
                                    <a className="dropdown-item uppercase" href="edit-category.html"><i className="fa fa-trash" />Edit</a>
                                    <a className="dropdown-item uppercase" href="#" data-toggle="modal" data-target="#inactivatecateg"><i className="fa fa-circle" />Inactive</a>
                                  </div>
                                </div>
                              </td>
                            </tr>
